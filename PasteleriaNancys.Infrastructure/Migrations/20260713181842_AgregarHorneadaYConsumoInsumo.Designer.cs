...
namespace PasteleriaNancys.Infrastructure.Migrations
{
    ...
    [Migration("20260713181842_AgregarHorneadaYConsumoInsumo")]
    partial class AgregarHorneadaYConsumoInsumo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PasteleriaNancys.Domain.Inventario.Horneada", b =>
                {
                    ...
                    b.Property<int>("CantidadBatidasChocolate")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Horneada", "Inventario", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Inventario_Horneada_CantidadBatidasChocolate", "[CantidadBatidasChocolate] >= 0 AND [CantidadBatidasChocolate] <= [CantidadBatidas]");
                        });
                });
