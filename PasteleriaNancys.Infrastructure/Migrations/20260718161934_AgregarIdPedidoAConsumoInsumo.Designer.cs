...
namespace PasteleriaNancys.Infrastructure.Migrations
{
    ...
    [Migration("20260718161934_AgregarIdPedidoAConsumoInsumo")]
    partial class AgregarIdPedidoAConsumoInsumo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PasteleriaNancys.Domain.Inventario.ItemCatalogo", b =>
                {
                    ...
                    b.ToTable("Item_Catalogo", "Inventario", t =>
                        {
                            t.HasCheckConstraint("CK_Inventario_Item_Categoria", "([Tipo]='Terminado' AND [Categoria] IN ('Tortas Clásicas','Tortas Personalizables')) OR ([Tipo]='MateriaPrima' AND [Categoria] IN ('Harinas y Secos','Lácteos y Cremas','Colorantes y Jaleas','Rellenos','Empaques')) OR ([Tipo]='Intermedio' AND [Categoria] IN ('Bizcochos','Preparados'))");
            ...
            modelBuilder.Entity("PasteleriaNancys.Domain.Inventario.Merma", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("Merma", "Inventario", t =>
                        {
                            t.HasCheckConstraint("CK_Inventario_Merma_Cantidad", "[Cantidad] > 0");

                            t.HasCheckConstraint("CK_Inventario_Merma_Tipo", "[TipoMerma] IN ('Insumo dañado','Producción fallida','Caducidad','Accidente','Otro')");
                        });
                });
            ...
            modelBuilder.Entity("PasteleriaNancys.Domain.Inventario.ConsumoInsumo", b =>
                {
                    ...
                    b.HasOne("PasteleriaNancys.Domain.Inventario.LotePeps", "LoteProducido")
                        .WithMany()
                        .HasForeignKey("IdLoteProducido")
                        .OnDelete(DeleteBehavior.Restrict);
